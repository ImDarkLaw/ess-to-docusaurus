...
:::tip
Just installed EssentialsDiscordLink? Check out our comprehensive [tutorials page](../../tutorials/discordlinktut) for step-by-step instructions on getting the plugin up and running smoothly!
:::
