...
EssentialsX is based on Bukkit and we recommend running it on [Paper](https://papermc.io/software/paper).
See [here](#Supported-Server-Versions-and-Software) for further info.
...
Updating EssentialsX is extremely easy. To do this, stop your server and replace your EssentialsX jar files with
updated ones from the [downloads page](https://essentialsx.net/downloads.html). Your configuration files will be unmodified.

:::info
To update the modules, ensure they match version with the core EssentialsX plugin.

To update the config, either generate a new one or copy https://git.io/JG4z1, your old config, and paste them at
...
your Essentials folder while the server is stopped.
:::
